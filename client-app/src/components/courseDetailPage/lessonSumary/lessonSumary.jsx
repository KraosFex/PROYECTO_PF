...
function LessonSumary({ lessons, idCourse, isLogged }) {
  ...
  if (lessons) {
    ...
    var completo = lessons.lesson.isCompleted === true ? "Completada" : "Disponible";
    return (
      <div className={style.flexContainer}>
        <div className={style.container}>
          <div className={style.flexContainer2}>
            <h3 className={style.title}>
              {lessons.lesson.titulo}
            </h3>
          ...
          <div className={style.flexContainer3}>
            {isLogged?
              <NavLink to={`/course/${idCourse}/${lessons.lesson._id}`}> Ver Clase </NavLink>
              :
